...
class User(AbstractUser):
    ...
    favourite_genre = models.CharField(
        max_length=2, choices=get_genres(), default="NO", blank=True
    )
...
class Club(models.Model):
    ...
    pending_members = models.ManyToManyField(
        User, related_name="pending_member_of", blank=True
    )
    ...
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="owned_clubs"
    )
    bio = models.CharField(max_length=500, blank=True)
    rules = models.CharField(max_length=1000, blank=True)
    theme = models.CharField(
        max_length=2, choices=get_themes(), blank=False, default=""
    )
    book = models.ForeignKey(
        FeaturedBook, on_delete=models.CASCADE, null=True, blank=True
    )
...
class Post(models.Model):
    ...
    in_club = models.ForeignKey(
        Club, on_delete=models.CASCADE, related_name="club_posts"
    )
...
class Comments(models.Model):
    ...
    club = models.ForeignKey(
        Club, on_delete=models.CASCADE, related_name="user_comments"
    )

    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="published_comments"
    )
...
class Event(models.Model):
    club = models.ForeignKey(
        Club, on_delete=models.CASCADE, related_name="upcoming_events"
    )
    ...
    selectedBook = models.ForeignKey(
        Book,
...
class AttendEvent(models.Model):
    ...
    event = models.ForeignKey(
        Event, on_delete=models.CASCADE, related_name="attend_event"
    )
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="attend_event"
    )
