# Generated by Django 4.1.3 on 2023-03-24 11:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(message='Club name cannot contain numbers and special characters in their name.', regex='^[a-zA-Z0-9_ ]*$')])),
                ('bio', models.CharField(blank=True, max_length=500)),
                ('rules', models.CharField(blank=True, max_length=1000)),
                ('theme', models.CharField(choices=[('E', 'Ebooks'), ('A', 'Arts'), ('BM', 'Biographies & Memoirs'), ('BI', 'Business & Investing'), ('C', 'Comics'), ('CT', 'Computers & Technology'), ('CF', 'Cookery, Food & Wine'), ('F', 'Fantasy'), ('FL', 'Fiction & Literature'), ('G', 'Gardening'), ('HF', 'Health & Fitness'), ('HM', 'Health, Mind & Body'), ('H', 'History'), ('M', 'Mystery & Thrillers'), ('N', 'Nature'), ('P', 'Poetry'), ('PC', 'Politics & Current Affairs'), ('R', 'Reference'), ('RO', 'Romance'), ('RS', 'Religion & Spirituality'), ('S', 'Science'), ('SF', 'Science Fiction'), ('SP', 'Sports'), ('T', 'Travel'), ('Y', 'Young Adult')], default='', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Event',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='pending_member_of', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
